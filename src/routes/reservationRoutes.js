...
// Route pour les notifications admin - accessible aux admins seulement
router.get("/recent", restrictTo("admin"), reservationController.getRecent);
...
router.put("/:id", upload.single("attachment"), reservationController.update);
